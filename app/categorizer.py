...
def main():
    ...
    categorizer = DocumentCategorizer(config={
        'ai': {'categorization': {'enabled': False}},
        'categories': {'keywords': {'Rechnungen': ['rechnung'], 'Versicherungen': ['versicherung']}}
